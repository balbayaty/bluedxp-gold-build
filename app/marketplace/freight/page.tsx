...
export default function FreightServicesPage() {
  ...
  const loadListings = async () => {
    ...
    try {
      ...
      console.error("Failed to load freight listings:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <PageTemplate
      ...
      description="Find FCL, LCL, Air, Sea, and Rail freight services"
      icon="ri-ship-line"
    >
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-bold text-slate-800 mb-4">
            {loading
              ? "Loading..."
              : `${listings.length} Freight Services Available`}
          </h2>
