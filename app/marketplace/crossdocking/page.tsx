...
export default function CrossDockingServicesPage() {
  ...
  const loadListings = async () => {
    ...
    try {
      ...
      console.error("Failed to load cross-docking listings:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <PageTemplate
      ...
      description="Find cross-docking and flow-through services"
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-bold text-slate-800 mb-4">
            {loading
              ? "Loading..."
              : `${listings.length} Cross-Docking Services Available`}
          </h2>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-xl shadow-lg p-12 text-center">
              <h3 className="text-xl font-semibold text-slate-800 mb-2">
                No cross-docking services found
              </h3>
