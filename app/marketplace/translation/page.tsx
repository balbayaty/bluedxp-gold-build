...
export default function TranslationServicesPage() {
  ...
  const loadListings = async () => {
    ...
    try {
      ...
      console.error("Failed to load translation listings:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <PageTemplate
      ...
      description="Find certified translation services in multiple languages"
      icon="ri-translate-2"
    >
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-bold text-slate-800 mb-4">
            {loading
              ? "Loading..."
              : `${listings.length} Translation Services Available`}
          </h2>
