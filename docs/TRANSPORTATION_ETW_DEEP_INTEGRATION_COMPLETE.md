# ✅ Transportation & ETW (e-Waybill) - Deep Integration Complete
...
**When**: ETW is created with shipmentId
...
- ✅ Publishes bidirectional link event
...
**Commercial**:
- ✅ Shipment Number → ETW Invoice Number
- ✅ Total Value → ETW Invoice Value
