...
export default function InnovationHeader({
  ...
  const navItems = [
    { name: language === "ar" ? "الذكاء الاصطناعي" : "AI", href: "#ai" },
    {
      name: language === "ar" ? "التفاعل" : "Interactive",
      href: "#interactive",
    },
    { name: language === "ar" ? "الميزات" : "Features", href: "#features" },
    { name: language === "ar" ? "التكنولوجيا" : "Technology", href: "#tech" },
  ];
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <motion.button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg font-medium"
              whileHover={{ scale: 1.05 }}
            >
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="md:hidden bg-[#0a0a0f]/98 backdrop-blur-md border-t border-white/10"
